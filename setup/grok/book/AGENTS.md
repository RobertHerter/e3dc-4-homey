...
**Vor jeder e3dc-Session:** `PROJEKT-REGELN.md` im Repo lesen (lokal, nicht im Git; wird per Syncthing zwischen Book und Arctic synchronisiert). Repo-`AGENTS.md` ergänzt die Kurzregeln.
